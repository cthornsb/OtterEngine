...
std::string ott::CurrentWorkingDirectory() {
#ifndef WIN32
...
bool ott::SetCurrentWorkingDirectory(const std::string& path) {
#ifndef WIN32
...
std::string ott::ExecutingDirectory() {
	std::string path = ott::ExecutingPath();
#ifndef WIN32
...
std::string ott::AssetsPath(const std::string& filename/*=""*/) {
