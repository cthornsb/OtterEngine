...
public:
	...
	/** Constructor taking the width and height of the window
	  */
	Window(const int32_t &width, const int32_t &height) : renderer(NULL), window(NULL), W(width), H(height), nMult(2), init(false) { }
	...
	/** Set the integer pixel scaling multiplier (default = 1)
	  */
	void setScalingFactor(const int32_t &scale){ nMult = scale; }
	...
	/** Draw a single pixel at position (x, y)
	  */
	void drawPixel(const int32_t &x, const int32_t &y);
	...
	/** Draw multiple pixels at positions (x1, y1) (x2, y2) ... (xN, yN)
	  ...
	  */
	void drawPixel(const int32_t *x, const int32_t *y, const size_t &N);
	
	/** Draw a single line to the screen between points (x1, y1) and (x2, y2)
	  */
	void drawLine(const int32_t &x1, const int32_t &y1, const int32_t &x2, const int32_t &y2);
	...
	/** Draw multiple lines to the screen
	  ...
	  */
	void drawLine(const int32_t *x, const int32_t *y, const size_t &N);
...
private:
	...
	int32_t W; ///< Width of the window (in pixels)
	int32_t H; ///< Height of the window (in pixels)
	int32_t nMult; ///< Integer multiplier for window scaling
