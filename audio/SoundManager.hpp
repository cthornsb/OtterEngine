...
typedef int32_t (*portCallback)( const void*, void*, unsigned long, const PaStreamCallbackTimeInfo*, PaStreamCallbackFlags, void* );
...
public:
	...
	/** Set the number of audio channels (default = 2)
	  ...
	  */
	void setNumberOfChannels(const int32_t& channels){ 
		nChannels = channels; 
	}
	...
	/** Default port callback function
	  */
	static int32_t defaultCallback( 
		const void *input, 
		void *output, 
